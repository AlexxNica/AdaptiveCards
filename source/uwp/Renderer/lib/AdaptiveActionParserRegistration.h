...
namespace AdaptiveCards { namespace Uwp
{
    ...
    class SharedModelActionParser : public AdaptiveCards::IBaseActionElementParser
    {
    public:
    ...
    private:
        std::shared_ptr<AdaptiveCards::Uwp::AdaptiveActionParserRegistration> m_parserRegistration;
    };
}}
